            ...
            <div className='space-y-3'>
                ...
                <div>
                    <ul className='flex flex-wrap items-center gap-6 justify-center md:justify-start p-2'>
                        ...
                        <li><i className="fa-brands fa-python text-[#1E90FF]"></i> Python</li>
                        <li> <i className="fa-solid fa-database text-[#1E90FF]"></i> SQL</li>
                        <li><i className="fa-brands fa-square-git text-[#1E90FF]"></i> Git</li>
                    </ul>
                </div>
            </div>
        </div>
